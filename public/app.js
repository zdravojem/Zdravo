...
function buildRecipeShareBody(state, recipe, recipeCopy) {
  ...
  return [
    ...
    recipeCopy.preparationMethod ? `${labels.preparationMethod}: ${recipeCopy.preparationMethod}` : '',
    recipeCopy.additionalTip ? `${labels.additionalTip}: ${recipeCopy.additionalTip}` : '',
    '',
    `${labels.ingredients}:`,
    ...ingredientLines,
    '',
